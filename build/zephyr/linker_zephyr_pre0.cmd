...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8000100 + 0x0), LENGTH = (32768 * 1024 - 0x0 - 0x0)
    RAM (wx) : ORIGIN = (553648128), LENGTH = (524288)
 ...
 *(.iplt)
 ...
 __rom_region_start = (0x8000100 + 0x0);
    rom_start :
 {
...
_nocache_load_rom_start = LOADADDR(nocache_load);
...
_rom_attr = ((1 << 17) | _rom_region_order | (7 << 24));
.intList :
{
 KEEP(*(.irq_info*))
 KEEP(*(.intList*))
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = (553648128) + (524288);
