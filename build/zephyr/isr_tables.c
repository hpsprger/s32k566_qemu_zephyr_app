...
const uintptr_t __irq_vector_table _irq_vector_table[239] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[239] = {
	...
	{(const void *)0x8006eb8, (ISR)0x8006971}, /* 30 */
